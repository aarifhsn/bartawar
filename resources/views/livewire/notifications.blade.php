<div id="toast-notification"
    ...
    <div class="flex items-center justify-between mb-3">
        ...
        <button class="p-2 bg-blue-500 text-white rounded-lg" wire:click="markAllAsRead">Mark All as Read</button>
        ...
        <div class="flex items-center my-4 {{ $notification->read_at ? 'bg-slate-50' : 'bg-slate-200' }} p-4 rounded-lg">
            ...
            <div class="ms-3 text-sm font-normal">
                <div class="flex justify-between">
                    ...
                    <button class="flex items-start" wire:click="markAsRead('{{ $notification->id }}')">Mark as
                        Read</button>
                </div>
